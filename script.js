...
function flower(f,t){
  ...
  ctx.lineWidth=2.35;ctx.lineCap="round";ctx.lineJoin="round";ctx.strokeStyle="rgba(83,127,94,.95)";ctx.stroke();
  // leaves
...
function drawGrass(t){
  grass.forEach((g,i)=>{
    ...
    ctx.lineWidth=1.25;ctx.lineCap="round";ctx.lineJoin="round";ctx.strokeStyle="rgba(67,106,76,.7)";ctx.stroke();
  });
}
